module("luci.controller.easycwmptable", package.seeall)

function index()

    entry({"admin", "pxrouter"}, firstchild(), _("Diagnostics"), 10).dependent = false
    entry({"admin", "pxrouter", "easycwmp"}, call("get_easycwmp_table"), _("Easycwmp"), 10)
...
function get_easycwmp_table()
    ...
    local api_endpoint = "/cgi-bin/luci/pxrouter/get_easycwmp_short_list"
    ...
    luci.template.render("pxrouter/easycwmp_main", {
